  ...
  return (
    <div className=" max-w-[1440px] mx-auto bg-[#F5F4F2]">
      ...
      <div className=" grid grid-cols-10 gap-0 md:gap-5 lg:gap-10 items-start pt-20 lg:pt-28">
        <div className="h-screen overflow-y-auto col-span-2 md:col-span-1 lg:col-span-2 sticky top-0 md:top-20 lg:top-28">
       <Sidebar1 />
        </div>
        <div className=" col-span-8 md:col-span-9 lg:col-span-5 pr-4 md:pr-12 lg:pr-0 text-justify"> 
        <Center />
        </div>
